    ...
    <div class="bu-footer-grid">
      ...
      <div class="bu-footer-col bu-footer-info-col">
        <div class="bu-footer-logo-wrap">
          <img src="<?php echo URL_IMG;?>bhabha-university-logo-hd.png" alt="Bhabha University Logo" class="bu-footer-logo" width="44" height="44" loading="lazy" decoding="async" onerror="this.src='<?php echo URL_IMG;?>logo.png'">
