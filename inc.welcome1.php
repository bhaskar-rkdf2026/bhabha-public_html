...
<div class="item"> 
              ...
              <div class="edu2_faculty_des">
                <div class="edu2_faculty_des2">
                  ...
                  <p ><a style="color:#000;" href="<?php echo href("announcements.php","id=".$ievents['id']."");?>"><?php echo $ievents['description']?></a></p>
                </div>
              </div>
              <!-- FACULTY DES END--> 
            </div>
        ...
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/SRB619sLYE0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
      <div class="col-md-7"> 
        <!-- HEADING 2 END-->
        ...
        <div class="kf_intro_des">
          <div class="kf_intro_des_caption"> <span><i class="fa fa-book"></i></i></span>
            <h6>BOOKS & LIBRARY</h6>
          </div>
        ...
        <!-- INTERO DES END--> 
        <!-- INTERO DES START-->
        <a href="<?php echo href("solar.php")?>">
        <div class="kf_intro_des">
