...
<title>Schools & Faculties - Bhabha University Bhopal</title>
<meta name="description" content="Explore multidisciplinary schools at Bhabha University Bhopal — Engineering, Pharmacy, Dental, Nursing, Management, Law, Agriculture, Science, and Education.">
...
<div class="kode_wrapper">
  ...
  <?php
  $page_title    = 'Schools & <em>Faculties</em>';
  $page_subtitle = 'Discover our multidisciplinary schools offering undergraduate, postgraduate, and doctoral degree programmes.';
  $page_icon     = 'fa-graduation-cap';
  $breadcrumbs   = [
    ['label' => 'Home',    'url' => URL_ROOT],
    ['label' => 'Schools & Faculties', 'url' => '#'],
  ];
  ...
  <div class="bu-full-width-container">
    <main>
      <div class="bu-content-card">
        <span class="bu-content-label">Academic Offerings</span>
        <h2 class="bu-content-h2">Explore Our <em>Schools</em></h2>
