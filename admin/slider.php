...
$action='';
$action=$_GET['action'];
define("PAGE",'slider.php');
define("TITLE",'Slider');
define("DBTAB",'slider');
define("UPLOAD",'../upload/slider/');
...
if(isset($_POST['submit']))
{
	...
	if($_REQUEST['action']=="add" && count($stat) == 0)	
	{
		$data = Array(
					...
					resizeBySize($newfile,1680,650,UPLOAD,false);
					}
              ...
              <div class="card-body">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="top_heading" class="form-control"  value="<?php if($action=="edit"){echo $aryData['top_heading'];}else{echo $_POST['top_heading'];}?>"/>
                  </div>
                  <div class="form-group col-xs-12">
