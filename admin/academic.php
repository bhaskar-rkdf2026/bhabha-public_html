...
if(isset($_POST['submit']))
{
		foreach($_POST as $field=>$value)
		{
			...
			$db->update ('academic', $data);
		}
		$stat['success']='Academic Setting Update';
...
<title>Academic Setting Dashboard - Silvery Infotech</title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card m-b-20">
              <div class="card-body">
                <h4 class="mt-0 header-title">Academic Settings</h4>
