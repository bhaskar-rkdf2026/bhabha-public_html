...
<div id="wrapper"><!-- Top Bar Start -->
         ...
         if(is_array($course) && count($course)>0)
          {
              foreach($course as $icourse)
              {
                ...
                ><?php echo $icourse['course']?></option>
                <?php
			  }
		  }?>
                    </select>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="branch" class="form-control"  value="<?php if($action=="edit"){echo $aryData['branch'];}else{echo $_POST['branch'];}?>"/>
                  </div>
  ...
  ?>
              ...
              foreach($aryData as $iList)
              {
                ?>
                      <tr>
                        <td><?php echo ucfirst($iList['branch']);?></td>
                        <td><?php
