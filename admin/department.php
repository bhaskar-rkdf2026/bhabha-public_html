...
if(isset($_POST['submit']))
{
	if($_REQUEST['action']=="add" && count($stat) == 0)	
	{
		$data = Array(
					...
					"dean_message" => $_POST['dean_message'],
              ...
              <div class="card-body">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="description" class="form-control"  value="<?php if($action=="edit"){echo $aryData['description'];}else{echo $_POST['description'];}?>"/>
                  </div>
                  <div class="form-group col-xs-12">
                    <label>Icon</label>
                    <input type="text" name="icon" class="form-control"  value="<?php if($action=="edit"){echo $aryData['icon'];}else{echo $_POST['icon'];}?>"/>
                  </div>
                  <div class="form-group col-xs-12">
                    <label>Data</label>
                    <textarea name="about" class="form-control ckeditor" rows="3" ><?php if($action=="edit"){echo $aryData['about'];}else{echo $_POST['about'];}?>
</textarea>
                  </div>
