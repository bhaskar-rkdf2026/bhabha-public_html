              ...
              foreach($department as $idepartment)
              {
                ...
                >
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="checkbox" name="is_home" value="1" <?php if($action=="edit"){
					  if($aryData['is_home']==1){?> checked="checked" <?php }}?>/>
                  </div>
                  <div class="form-group col-xs-12">
                    <label>Image</label>
              ...
              foreach($aryData as $iList)
              {
                ?>
                      <tr>
                        ...
                        <td><img src="<?php echo URL_ROOT?>upload/gallery/<?php echo $iList['image'];?>" width="80" height="80"></td>
