...
$action='';
$action=$_GET['action'];
define("PAGE",'links.php');
define("TITLE",'Quick Links');
define("DBTAB",'links');
              ...
              <div class="card-body">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="link" class="form-control"  value="<?php if($action=="edit"){echo $aryData['link'];}else{echo $_POST['link'];}?>"/>
                  </div>
                  <div class="form-group col-xs-12">
                    <label>Status</label>
