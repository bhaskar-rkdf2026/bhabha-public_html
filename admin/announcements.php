...
define("TITLE",'News & Announcements');
define("DBTAB",'news_and_announcement');
...
if(isset($_POST['submit']))
{
	if($_REQUEST['action']=="add" && count($stat) == 0)	
	{
		$data = Array(
					...
					"is_announcement" => $_POST['is_announcement'],
              ...
              <div class="card-body">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <textarea name="description" class="form-control ckeditor" rows="3" ><?php if($action=="edit"){echo $aryData['description'];}else{echo $_POST['description'];}?>
</textarea>
                  </div>
                  <div class="form-group col-xs-12">
                    <label>Is News?</label>
                    <input type="checkbox" name="is_news" value="1" <?php if($action=="edit"){ if($aryData['is_news']==1){ echo "checked";}}?>>
                  </div>
                  <div class="form-group col-xs-12">
                    <label>Is Announcements?</label>
                    <input type="checkbox" name="is_announcement" value="1" <?php if($action=="edit"){ if($aryData['is_announcement']==1){ echo "checked";}}?>>
                  </div>
                  <div class="form-group col-xs-12">
                    <label>Status</label>
