              ...
              <div style="margin-left:10px; margin-right:10px;"> <?php echo msg($stat);?></div>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-xs-12">
                   ...
                   <div class="form-group col-xs-12">
                    <label>Page Identity</label>
                    <input type="text" name="identity" class="form-control"  value="<?php if($action=="edit"){echo $aryData['identity'];}else{echo $_POST['identity'];}?>"/>
                  </div>
                  <div class="form-group col-xs-12">
                    <label>Page Content</label>
                    <textarea name="data" class="form-control ckeditor" rows="3" ><?php if($action=="edit"){echo $aryData['data'];}else{echo $_POST['data'];}?>
</textarea>
                  </div>
