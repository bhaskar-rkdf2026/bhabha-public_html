    ...
    <div class="bu-infra-collage-col">
      <div class="bu-collage-wrapper">
        <div class="bu-collage-main">
          <img src="<?php echo URL_IMG; ?>library.jpg" alt="Bhabha University Campus Green Lawn" class="bu-collage-img">
        </div>
        <div class="bu-collage-side">
          <div class="bu-collage-side-top">
            <img src="<?php echo URL_IMG; ?>solar.jpg" alt="Bhabha University Campus Gate" class="bu-collage-img">
          </div>
          <div class="bu-collage-side-bottom">
            <img src="<?php echo URL_IMG; ?>radio.jpg" alt="Bhabha University Students" class="bu-collage-img">
          </div>
        </div>
      </div>
    </div>
